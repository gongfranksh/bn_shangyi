...
class sync_shangyi_info(osv.osv):
    _name = 'sync.shangyi.info'
    _columns = {
    ...
    def synch_pos_order(self, cr, uid, ids, sy_product_date, context=None):
        ...
        exec_sql="""
            SELECT bs.BraId,convert(VARCHAR(10),bs.SaleDate,126),DATEADD(hour,-8,bs.SaleDate) AS SaleDate,
